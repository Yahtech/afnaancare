...
(function() {
  ...
  function updateHeroText(newHeading, newParagraph) {
    document.getElementById('hero-heading').textContent = newHeading;
    document.getElementById('hero-paragraph').textContent = newParagraph;
  }

  // Example: Update text dynamically after 5 seconds
  setTimeout(() => {
    updateHeroText(
      'Discover the Future',
      'Explore cutting-edge solutions and innovations with us. Together, we redefine what is possible and shape the future.'
    );
  }, 5000);
...
document.addEventListener("DOMContentLoaded", function() {
  const text = "At Afnaan Care, we are relentless in our resolve to make positive impact on the persons we care for and their families at large...";
